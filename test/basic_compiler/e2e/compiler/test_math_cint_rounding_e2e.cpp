 ...
 * Purpose: Validate End-to-End (compile + run) behavior for test_math_cint_rounding_e2e.cpp.
...
TEST(E2E, CintRoundsHalfAwayFromZero) {
    ...
    const std::filesystem::path tmp = std::filesystem::path("..") / "tmp" / "gwbasic_e2e_cint_round";
